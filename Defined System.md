...
- When getting attacked by a non-AOE ability, you may spend a die or dice based on dice used to deal damage to you. If an opponent used 1d4 to hurt you, spend 1d4 to block. Blocking reduces the damage of an attack to zero.
...
- When making a Long Jump you spend an <span style="font-weight:bold; color:rgb(33, 235, 60)">Action Die</span> and move in any direction that many tiles + your Deftness or Strength Modifier. While jumping you many move through single height tiles, and through Harsh Ground without taking a movement penalty. 
